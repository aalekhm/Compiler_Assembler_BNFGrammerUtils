...
namespace TokenType_
{
	...
	inline std::string toString(Type eType)
	{
		switch (eType)
		{
			...
			case Type::TK_PBXNUMBER:			return "TK_PBXNUMBER";
			case Type::TK_PBXIDENTIFIER:		return "TK_PBXIDENTIFIER";
	...
	inline TokenType_::Type fromString(std::string sTokenType)
	{
		...
		else if (sTokenType == "TK_PBXNUMBER")			return Type::TK_PBXNUMBER;
		else if (sTokenType == "TK_PBXIDENTIFIER")		return Type::TK_PBXIDENTIFIER;
...
enum class ASTNodeType
{
	...
	ASTNode_SYSTEMFUNCTIONCALL,
	ASTNode_SYSTEMFUNCTIONCALLEND,
	TK_UNKNOWN
};

	enum class E_ASMREGISTERS
	{
		NONE = -1,
		EDI,
		ESI,
	...
	static E_ASMREGISTERS stringToAsmRegister(std::string sReg)
	{
		if (sReg == "EDI")
			return E_ASMREGISTERS::EDI;
		else if(sReg == "ESI")
			return E_ASMREGISTERS::ESI;
		else if(sReg == "ESP")
			return E_ASMREGISTERS::ESP;
		else if(sReg == "EBP")
			return E_ASMREGISTERS::EBP;
		else if(sReg == "EAX")
			return E_ASMREGISTERS::EAX;
		else if(sReg == "EBX")
			return E_ASMREGISTERS::EBX;
		else if(sReg == "ECX")
			return E_ASMREGISTERS::ECX;
		else if(sReg == "EDX")
			return E_ASMREGISTERS::EDX;
		else if(sReg == "R0")
			return E_ASMREGISTERS::R0;
		else if(sReg == "R1")
			return E_ASMREGISTERS::R1;
		else if(sReg == "R2")
			return E_ASMREGISTERS::R2;
		else if(sReg == "R3")
			return E_ASMREGISTERS::R3;
		else if(sReg == "R4")
			return E_ASMREGISTERS::R4;
		else if(sReg == "R5")
			return E_ASMREGISTERS::R5;
		else if(sReg == "R6")
			return E_ASMREGISTERS::R6;
		else if(sReg == "R7")
			return E_ASMREGISTERS::R7;
		else if(sReg == "AX")
			return E_ASMREGISTERS::AX;
		else if(sReg == "BX")
			return E_ASMREGISTERS::BX;
		else if(sReg == "CX")
			return E_ASMREGISTERS::CX;
		else if(sReg == "DX")
			return E_ASMREGISTERS::DX;
		else if(sReg == "AH")
			return E_ASMREGISTERS::AH;
		else if(sReg == "BH")
			return E_ASMREGISTERS::BH;
		else if(sReg == "CH")
			return E_ASMREGISTERS::CH;
		else if(sReg == "DH")
			return E_ASMREGISTERS::DH;
		else if(sReg == "AL")
			return E_ASMREGISTERS::AL;
		else if(sReg == "BL")
			return E_ASMREGISTERS::BL;
		else if(sReg == "CL")
			return E_ASMREGISTERS::CL;
		else if(sReg == "DL")
			return E_ASMREGISTERS::DL;
	}

	enum class E_OPCODEASM
	{
		NONE,
		...
		ASM_XOR_R_R = 176, //0xB0
		ASM_XOR_R_M,
		ASM_XOR_R_K,
		ASM_XOR_M_R,
		ASM_XOR_M_K,

		ASM_SHL_R_R = 192, //0xC0
		ASM_SHL_R_K,
		ASM_SHL_M_R,
		ASM_SHL_M_K,

		ASM_SHR_R_R = 208, //0xD0
		ASM_SHR_R_K,
		ASM_SHR_M_R,
		ASM_SHR_M_K,
	...
	static std::string opCodeToString(E_OPCODEASM eOpCode)
	{
		switch (eOpCode)
		{
			case E_OPCODEASM::ASM_MOVB_R_R:
			case E_OPCODEASM::ASM_MOVB_R_M:
			case E_OPCODEASM::ASM_MOVB_R_K:
			case E_OPCODEASM::ASM_MOVB_M_R:
			case E_OPCODEASM::ASM_MOVB_M_K:
				return "MOVB";
			case E_OPCODEASM::ASM_MOVW_R_R:
			case E_OPCODEASM::ASM_MOVW_R_M:
			case E_OPCODEASM::ASM_MOVW_R_K:
			case E_OPCODEASM::ASM_MOVW_M_R:
			case E_OPCODEASM::ASM_MOVW_M_K:
				return "MOVW";
			case E_OPCODEASM::ASM_MOVD_R_R:
			case E_OPCODEASM::ASM_MOVD_R_M:
			case E_OPCODEASM::ASM_MOVD_R_K:
			case E_OPCODEASM::ASM_MOVD_M_R:
			case E_OPCODEASM::ASM_MOVD_M_K:
				return "MOVD";
			case E_OPCODEASM::ASM_HLT:
				return "HLT";
			case E_OPCODEASM::ASM_CALL:
				return "CALL";
			case E_OPCODEASM::ASM_RET:
				return "RET";
			case E_OPCODEASM::ASM_NOT_R:
			case E_OPCODEASM::ASM_NOT_M:
				return "NOT";
			case E_OPCODEASM::ASM_NEW:
				return "NEW";
			case E_OPCODEASM::ASM_FREE:
				return "FREE";
			case E_OPCODEASM::ASM_NEG_R:
			case E_OPCODEASM::ASM_NEG_M:
				return "NEG";
			case E_OPCODEASM::ASM_NOP:
				return "NOP";
			case E_OPCODEASM::ASM_PUSH_R:
			case E_OPCODEASM::ASM_PUSH_M:
			case E_OPCODEASM::ASM_PUSH_K:
				return "PUSH";
			case E_OPCODEASM::ASM_POP_R:
			case E_OPCODEASM::ASM_POP_M:
				return "POP";
			case E_OPCODEASM::ASM_LEA_R_M:
				return "LEA";
			case E_OPCODEASM::ASM_ADD_R_R:
			case E_OPCODEASM::ASM_ADD_R_M:
			case E_OPCODEASM::ASM_ADD_R_K:
			case E_OPCODEASM::ASM_ADD_M_R:
			case E_OPCODEASM::ASM_ADD_M_K:
				return "ADD";
			case E_OPCODEASM::ASM_SUB_R_R:
			case E_OPCODEASM::ASM_SUB_R_M:
			case E_OPCODEASM::ASM_SUB_R_K:
			case E_OPCODEASM::ASM_SUB_M_R:
			case E_OPCODEASM::ASM_SUB_M_K:
				return "SUB";
			case E_OPCODEASM::ASM_INC_R:
			case E_OPCODEASM::ASM_INC_M:
				return "INC";
			case E_OPCODEASM::ASM_DEC_R:
			case E_OPCODEASM::ASM_DEC_M:
				return "DEC";
			case E_OPCODEASM::ASM_IMUL_R_R:
			case E_OPCODEASM::ASM_IMUL_R_M:
			case E_OPCODEASM::ASM_IMUL_R_K:
			case E_OPCODEASM::ASM_IMUL_R_R_K:
			case E_OPCODEASM::ASM_IMUL_R_M_K:
			case E_OPCODEASM::ASM_IMUL_R_K_K:
				return "IMUL";
			case E_OPCODEASM::ASM_IDIV_R:
			case E_OPCODEASM::ASM_IDIV_M:
				return "IDIV";
			case E_OPCODEASM::ASM_AND_R_R:
			case E_OPCODEASM::ASM_AND_R_M:
			case E_OPCODEASM::ASM_AND_R_K:
			case E_OPCODEASM::ASM_AND_M_R:
			case E_OPCODEASM::ASM_AND_M_K:
				return "AND";
			case E_OPCODEASM::ASM_OR_R_R:
			case E_OPCODEASM::ASM_OR_R_M:
			case E_OPCODEASM::ASM_OR_R_K:
			case E_OPCODEASM::ASM_OR_M_R:
			case E_OPCODEASM::ASM_OR_M_K:
				return "OR";
			case E_OPCODEASM::ASM_XOR_R_R:
			case E_OPCODEASM::ASM_XOR_R_M:
			case E_OPCODEASM::ASM_XOR_R_K:
			case E_OPCODEASM::ASM_XOR_M_R:
			case E_OPCODEASM::ASM_XOR_M_K:
				return "XOR";
			case E_OPCODEASM::ASM_SHL_R_K:
			case E_OPCODEASM::ASM_SHL_R_R:
			case E_OPCODEASM::ASM_SHL_M_R:
			case E_OPCODEASM::ASM_SHL_M_K:
				return "SHL";
			case E_OPCODEASM::ASM_SHR_R_K:
			case E_OPCODEASM::ASM_SHR_R_R:
			case E_OPCODEASM::ASM_SHR_M_R:
			case E_OPCODEASM::ASM_SHR_M_K:
				return "SHR";
			case E_OPCODEASM::ASM_JMP:
				return "JMP";
			case E_OPCODEASM::ASM_JE:
				return "JE";
			case E_OPCODEASM::ASM_JNE:
				return "JNE";
			case E_OPCODEASM::ASM_JZ:
				return "JZ";
			case E_OPCODEASM::ASM_JG:
				return "JG";
			case E_OPCODEASM::ASM_JGE:
				return "JGE";
			case E_OPCODEASM::ASM_JL:
				return "JL";
			case E_OPCODEASM::ASM_JLE:
				return "JLE";
			case E_OPCODEASM::ASM_CMP_R_R:
			case E_OPCODEASM::ASM_CMP_R_M:
			case E_OPCODEASM::ASM_CMP_R_K:
			case E_OPCODEASM::ASM_CMP_M_R:
			case E_OPCODEASM::ASM_CMP_M_K:
				return "CMP";
		};
	}

	enum class E_OPERAND_NUM
	{
		_0,
		_1,
		_2,
	...
	enum class E_MEMOP
	{
		NONE			= 0,
		BASE_REG		= 1,
		INDEX_REG		= BASE_REG << 1,
		SCALE			= INDEX_REG << 1,
		DISP_ADD_SUB	= SCALE << 1,
		DISP_CONST		= DISP_ADD_SUB << 1,
		MAX,
	};

	class MemOpData
	{
		std::map<E_MEMOP, std::string>	m_MemOpDataMap;
	};

	struct StmtOperand
	{
		StmtOperand()
		: m_eOperandType(E_OPERAND_TYPE::_NONE)
		, m_eMemoryOperandBit(0)
		{}

		std::string getDataForBit(E_MEMOP eE_MEMOP)
		{
			assert(eE_MEMOP > E_MEMOP::NONE && eE_MEMOP < E_MEMOP::MAX);
			if (eE_MEMOP > E_MEMOP::NONE && eE_MEMOP < E_MEMOP::MAX)
			{
				auto bStrItr = m_sMemoryOperandDataMap.find(eE_MEMOP);
				assert(bStrItr != m_sMemoryOperandDataMap.end());
				if (bStrItr != m_sMemoryOperandDataMap.end())
				{
					return bStrItr->second;
				}
			}
		...
		E_OPERAND_TYPE						m_eOperandType;
		int32_t								m_eMemoryOperandBit;

		std::string							m_sOperandData;
		std::map<E_MEMOP, std::string>		m_sMemoryOperandDataMap;
	};

	struct OpcodeStmt
	{
		OpcodeStmt(E_OPCODEASM eE_OPCODEASM)
		: m_eOpcode(eE_OPCODEASM)
		, m_iOperandCount(0)
		{}

		E_OPCODEASM						m_eOpcode;
		StmtOperand						m_Operands[(int32_t)E_OPERAND_NUM::_MAX];
		int32_t							m_iOperandCount;

		void setOperandType(E_OPERAND_NUM eE_OPERAND_NUM, E_OPERAND_TYPE eE_OPERAND_TYPE, std::string sData)
		{
			m_Operands[(int32_t)eE_OPERAND_NUM].m_eOperandType = eE_OPERAND_TYPE;
			m_Operands[(int32_t)eE_OPERAND_NUM].m_sOperandData = sData;

			if ((int32_t)eE_OPERAND_NUM >= m_iOperandCount)
				m_iOperandCount = (int32_t)eE_OPERAND_NUM + 1;
		}

		void setMemBit(E_OPERAND_NUM eE_OPERAND_NUM, E_MEMOP eE_MEMOP, std::string sData)
		{
			m_Operands[(int32_t)eE_OPERAND_NUM].m_eMemoryOperandBit |= (int32_t)eE_MEMOP;
			m_Operands[(int32_t)eE_OPERAND_NUM].m_sMemoryOperandDataMap[eE_MEMOP] = sData;
		}
	};
